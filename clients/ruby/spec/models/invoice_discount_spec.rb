...
# Unit tests for OpenapiClient::InvoiceDiscount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvoiceDiscount' do
  before do
    # run before each test
    @instance = OpenapiClient::InvoiceDiscount.new
  end
  ...
  describe 'test an instance of InvoiceDiscount' do
    it 'should create an instance of InvoiceDiscount' do
      expect(@instance).to be_instance_of(OpenapiClient::InvoiceDiscount)
    end
  end
