...
# Unit tests for OpenapiClient::ContractPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContractPlan' do
  before do
    # run before each test
    @instance = OpenapiClient::ContractPlan.new
  end
  ...
  describe 'test an instance of ContractPlan' do
    it 'should create an instance of ContractPlan' do
      expect(@instance).to be_instance_of(OpenapiClient::ContractPlan)
    end
  end
