...
# Unit tests for OpenapiClient::ProductMfrWarranty
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProductMfrWarranty' do
  before do
    # run before each test
    @instance = OpenapiClient::ProductMfrWarranty.new
  end
  ...
  describe 'test an instance of ProductMfrWarranty' do
    it 'should create an instance of ProductMfrWarranty' do
      expect(@instance).to be_instance_of(OpenapiClient::ProductMfrWarranty)
    end
  end
  ...
  describe 'test attribute "labor"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
