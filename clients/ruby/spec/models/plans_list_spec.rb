...
# Unit tests for OpenapiClient::PlansList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PlansList' do
  before do
    # run before each test
    @instance = OpenapiClient::PlansList.new
  end
  ...
  describe 'test an instance of PlansList' do
    it 'should create an instance of PlansList' do
      expect(@instance).to be_instance_of(OpenapiClient::PlansList)
    end
  end
