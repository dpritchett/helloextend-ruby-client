...
# Unit tests for OpenapiClient::InvoiceMetadataProduct
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvoiceMetadataProduct' do
  before do
    # run before each test
    @instance = OpenapiClient::InvoiceMetadataProduct.new
  end
  ...
  describe 'test an instance of InvoiceMetadataProduct' do
    it 'should create an instance of InvoiceMetadataProduct' do
      expect(@instance).to be_instance_of(OpenapiClient::InvoiceMetadataProduct)
    end
  end
