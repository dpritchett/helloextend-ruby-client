...
# Unit tests for OpenapiClient::ProductIdentifiers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProductIdentifiers' do
  before do
    # run before each test
    @instance = OpenapiClient::ProductIdentifiers.new
  end
  ...
  describe 'test an instance of ProductIdentifiers' do
    it 'should create an instance of ProductIdentifiers' do
      expect(@instance).to be_instance_of(OpenapiClient::ProductIdentifiers)
    end
  end
