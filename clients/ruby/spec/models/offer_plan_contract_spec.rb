...
# Unit tests for OpenapiClient::OfferPlanContract
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OfferPlanContract' do
  before do
    # run before each test
    @instance = OpenapiClient::OfferPlanContract.new
  end
  ...
  describe 'test an instance of OfferPlanContract' do
    it 'should create an instance of OfferPlanContract' do
      expect(@instance).to be_instance_of(OpenapiClient::OfferPlanContract)
    end
  end
  describe 'test attribute "coverage_starts"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "coverage_includes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "term_length"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
