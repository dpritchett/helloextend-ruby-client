...
# Unit tests for OpenapiClient::InvoicePayer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvoicePayer' do
  before do
    # run before each test
    @instance = OpenapiClient::InvoicePayer.new
  end
  ...
  describe 'test an instance of InvoicePayer' do
    it 'should create an instance of InvoicePayer' do
      expect(@instance).to be_instance_of(OpenapiClient::InvoicePayer)
    end
  end
