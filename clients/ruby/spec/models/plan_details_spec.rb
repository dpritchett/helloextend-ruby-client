...
# Unit tests for OpenapiClient::PlanDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PlanDetails' do
  before do
    # run before each test
    @instance = OpenapiClient::PlanDetails.new
  end
  ...
  describe 'test an instance of PlanDetails' do
    it 'should create an instance of PlanDetails' do
      expect(@instance).to be_instance_of(OpenapiClient::PlanDetails)
    end
  end
