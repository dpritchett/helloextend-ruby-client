...
# Unit tests for OpenapiClient::OfferPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OfferPlan' do
  before do
    # run before each test
    @instance = OpenapiClient::OfferPlan.new
  end
  ...
  describe 'test an instance of OfferPlan' do
    it 'should create an instance of OfferPlan' do
      expect(@instance).to be_instance_of(OpenapiClient::OfferPlan)
    end
  end
