...
# Unit tests for OpenapiClient::ContractProduct
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContractProduct' do
  before do
    # run before each test
    @instance = OpenapiClient::ContractProduct.new
  end
  ...
  describe 'test an instance of ContractProduct' do
    it 'should create an instance of ContractProduct' do
      expect(@instance).to be_instance_of(OpenapiClient::ContractProduct)
    end
  end
  ...
  describe 'test attribute "manufacturer_warranty_length"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "manufacturer_warranty_length_parts"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "manufacturer_warranty_length_labor"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
