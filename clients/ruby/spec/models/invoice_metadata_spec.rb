...
# Unit tests for OpenapiClient::InvoiceMetadata
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvoiceMetadata' do
  before do
    # run before each test
    @instance = OpenapiClient::InvoiceMetadata.new
  end
  ...
  describe 'test an instance of InvoiceMetadata' do
    it 'should create an instance of InvoiceMetadata' do
      expect(@instance).to be_instance_of(OpenapiClient::InvoiceMetadata)
    end
  end
