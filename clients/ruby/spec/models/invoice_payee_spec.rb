...
# Unit tests for OpenapiClient::InvoicePayee
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvoicePayee' do
  before do
    # run before each test
    @instance = OpenapiClient::InvoicePayee.new
  end
  ...
  describe 'test an instance of InvoicePayee' do
    it 'should create an instance of InvoicePayee' do
      expect(@instance).to be_instance_of(OpenapiClient::InvoicePayee)
    end
  end
