...
# Unit tests for OpenapiClient::InvoiceItems
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InvoiceItems' do
  before do
    # run before each test
    @instance = OpenapiClient::InvoiceItems.new
  end
  ...
  describe 'test an instance of InvoiceItems' do
    it 'should create an instance of InvoiceItems' do
      expect(@instance).to be_instance_of(OpenapiClient::InvoiceItems)
    end
  end
